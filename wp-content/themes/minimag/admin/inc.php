...
if ( !function_exists('minimag_admin_enqueue') ) :
	...
	function minimag_admin_enqueue() {
		...
		wp_enqueue_script( 'minimag-admin', get_template_directory_uri() . '/admin/js/functions.js', array( 'jquery' ) );	
		wp_enqueue_style( 'minimag-admin', get_template_directory_uri() . '/admin/css/style.css' );
