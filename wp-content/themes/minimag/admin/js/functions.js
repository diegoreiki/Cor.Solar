(function($) {
	...
	$(document).on("ready",function() {
		...
		/* Page Header */
		if( $('#minimag_cf_pageheader_onoff').val() == 'enable' ) {
			$('.cmb2-id-minimag-cf-pageheader-img').slideDown(500);
		}
		else {
			$('.cmb2-id-minimag-cf-pageheader-img').slideUp(500);
		}
		/* On Change : Event */
		$('#minimag_cf_pageheader_onoff').on('change', function() {
			if( $('#minimag_cf_pageheader_onoff').val() == 'enable' ) {
				$('.cmb2-id-minimag-cf-pageheader-img').slideDown(500);
			}
			else {
		...
		if( $('.cmb2-id-minimag-cf-sidebar-owlayout').length ) {
			...
			$('[id*="minimag_cf_sidebar_owlayout"]').on('change', function() {
		...
		if( $('#post-formats-select').length ) {
			...
			/* On Change : Event */
			$('#post-formats-select').on('change', function() {
		...
		if( $('#minimag_cf_post_video_source').val() == 'video_link' ) {
			...
			$('.cmb2-id-minimag-cf-post-videowidth').slideDown(500); /* Enable Video Width */
			...
			$('.cmb2-id-minimag-cf-post-videowidth').slideUp(500); /* Disable Video Width */
		...
		/* On Change : Event */
		$('#minimag_cf_post_video_source').on('change', function() {
		...
		/* Post : Audio */
		if( $('#minimag_cf_post_audio_source').val() == 'soundcloud_iframe' ) {
			$('.cmb2-id-minimag-cf-post-soundcloud-iframe').slideDown(500); /* Enable Soundcloud URL */
			$('.cmb2-id-minimag-cf-oembed-width').slideDown(500); /* Enable Audio Width */
			...
			$('.cmb2-id-minimag-cf-post-soundcloud-iframe').slideUp(500); /* Disable Soundcloud URL */
			$('.cmb2-id-minimag-cf-oembed-width').slideUp(500); /* Disable Audio Width */
		}
		else {
			$('.cmb2-id-minimag-cf-post-soundcloud-iframe').slideUp(500); /* Disable Soundcloud URL */
			$('.cmb2-id-minimag-cf-post-audio-local').slideUp(500); /* Disable Audio Local */
		...
		/* On Change : Event */
		$('#minimag_cf_post_audio_source').on('change', function() {
			if( $('#minimag_cf_post_audio_source').val() == 'soundcloud_iframe' ) {
				$('.cmb2-id-minimag-cf-post-soundcloud-iframe').slideDown(500); /* Enable Soundcloud URL */
				$('.cmb2-id-minimag-cf-oembed-width').slideDown(500); /* Enable Audio Width */
				$('.cmb2-id-minimag-cf-post-audio-local').slideUp(500); /* Disable Audio Local */
