...
function minimag_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'version' => '1.7', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
		...
		array(
			...
			'required' => true, // If false, the plugin is only 'recommended' instead of required.
			'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be de
			'version' => '6.6.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher.activated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		),
		array(
		...
		array(
			'name'               => esc_html__('Breadcrumb NavXT', 'minimag'), // The plugin name.
