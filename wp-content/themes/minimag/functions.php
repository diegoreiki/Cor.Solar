...
if( !function_exists('minimag_theme_setup') ) :
	...
	function minimag_theme_setup() {
		...
		register_nav_menus( array(
			...
			'minimag_footer'   => esc_html__( 'Footer Menu', "minimag" ),
		) );
...
if( !function_exists('minimag_enqueue_scripts') ) :
	...
	function minimag_enqueue_scripts() {
		...
		if( minimag_options('lightup_theme') == '1' ) {
			wp_enqueue_script( 'minimag-functions', get_template_directory_uri() . '/assets/js/functions-min.js', array( 'jquery' ) );
			wp_enqueue_style( 'minimag-stylesheet', get_template_directory_uri() . '/style-min.css' );
		}
		else {
			...
			wp_enqueue_script( 'isotope-pkgd', get_template_directory_uri() . '/assets/js/isotope.pkgd.min.js', array( 'jquery' ) );
...
if( !function_exists('minimag_socialshare_head') ) {

	function minimag_socialshare_head() {
		?>
